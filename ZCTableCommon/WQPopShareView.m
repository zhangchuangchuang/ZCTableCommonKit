...
#import "WQPopShareView.h"
#define ItemH kw(100)
#define kw(R)   (R) * (SCREEN_WIDTH) / 375.0
/** 屏幕高度和宽度 */
#define SCREEN_HEIGHT [ UIScreen mainScreen ].bounds.size.height
#define SCREEN_WIDTH  [ UIScreen mainScreen ].bounds.size.width
@interface WQPopShareView()
...
+ (void)showMoreWithTitle:(NSArray *)titleArray
    ...
    WQPopShareView *modeView = [[WQPopShareView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
...
- (void)bulidContentView{
    ...
    self.contentView = [[UIView alloc] initWithFrame:CGRectMake(0, SCREEN_HEIGHT, SCREEN_WIDTH, kw(50) + ((self.titleArray.count-1)/4+1)*ItemH + kw(30))];
