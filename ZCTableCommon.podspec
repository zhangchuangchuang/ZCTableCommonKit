#
#  Be sure to run `pod spec lint ZCTableCommon.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "zhangchuangchuang" => "1374618878@qq.com" }
  # Or just: spec.author    = "zhangchuangchuang"
  # spec.authors            = { "zhangchuangchuang" => "1374618878@qq.com" }
  # spec.social_media_url   = "https://twitter.com/zhangchuangchuang"
